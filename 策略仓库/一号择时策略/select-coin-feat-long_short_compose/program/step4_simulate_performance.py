...
from firm.backtest_core.equity import calc_equity
...
if __name__ == '__main__':
    ...
    _results = pd.read_pickle(get_file_path(backtest_path, backtest_name, 'final_select_results.pkl'))
